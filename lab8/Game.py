...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\User\OneDrive\Рабочий стол\PP2_2025\lab8\coin.png")  # Added the image of coin
        self.image = pygame.transform.scale(self.image, (40, 40))  # Resize to 30x30 pixels
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
